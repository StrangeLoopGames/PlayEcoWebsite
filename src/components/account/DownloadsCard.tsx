...
import { faWindows, faLinux, faApple, faUnity } from '@fortawesome/free-brands-svg-icons'
function DownloadsCard() {
    const stagingFilename = `{Model.CommitVersion2}{Model.CommitCategory2}-staging-{Model.CommitNumber}`
    return (
        <div className="account-feature account-download-wrapper">
            ...
            <div id="more-downloads-div">
                ...
                <div className="mb-4 text-left">
                    <div className="download-link"><a href="/s3/staging/EcoPC_v{stagingFilename}.zip"><i className="fab fa-windows"></i>{`game`}<div>{`win64`}</div></a></div>
                    <div className="download-link"><a href="/s3/staging/EcoPC_v{stagingFilename}.zip"><i className="fab fa-windows"></i>{`server`}<div>{`win64`}</div></a></div>
                    <div className="download-link"><a href="/s3/staging/EcoServerPC32_v{stagingFilename}.zip"><i className="fab fa-windows"></i>{`server`}<div>{`win32`}</div></a></div>
                    <div className="download-link"><a href="/s3/staging/EcoServerOSX_v{stagingFilename}.tar.gz"><i className="fab fa-apple"></i>{`server`}<div>{`mac`}</div></a></div>
                    <div className="download-link"><a href="/s3/staging/EcoServerLinux_v{stagingFilename}.zip"><i className="fab fa-linux"></i>{`server`}<div>{`linux`}</div></a></div>
                    <div className="download-link"><a href="/s3/staging/EcoModKit_v{stagingFilename}.zip"><i className="fab fa-unity"></i>{`modKit`}</a></div>
                </div>
